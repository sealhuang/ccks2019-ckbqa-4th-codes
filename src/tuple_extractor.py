...
class TupleExtractor(object):
    ...
    def extract_tuples(self, candidate_entitys, question):
        ...
        for entity in entity_list:
            ...
            for r in relations:
                ...
                # 初始化特征
                score = [entity]+candidate_entitys[entity]
    ...
    def GetCandidateAns(self, corpus):
        ...
        候选答案格式为 tuple(entity,relation1,relation2), 便于和标准答案对比
        """
        true_num = 0
        hop2_num = 0
        hop2_true_num = 0
