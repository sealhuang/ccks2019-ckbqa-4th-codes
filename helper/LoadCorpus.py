...
inputpaths = [
    '../corpus/task6ckbqa_train_2019.txt',
    '../corpus/task6ckbqa_valid_2019.txt',
    '../corpus/task6ckbqa_test_2019.txt',
]

outputpaths = [
    '../data/corpus_train.pkl',
    '../data/corpus_valid.pkl',
    '../data/corpus_test.pkl',
]

corpuses = []
for i in range(len(inputpaths)):
    inputpath = inputpaths[i]
    print('Process file %s'%(inputpath))
